...
public class EstimateController extends BaseController {
	...
	public ResponseEntity<Map<String, Object>> listAjax(@RequestParam Map<String, Object> param) throws Exception {
		...
		// List<Map<String, Object>> data = estimateService.listEstimate(param);

		List<Map<String, Object>> data = workService.selectWorkParentList(param);

		for (Map<String, Object> tmp : data) {
			returnMap.put("tbody" + tmp.get("work_no"), estimateService.listEstimate(tmp));
		}
	...
	@ResponseBody
	public ResponseEntity<Map<String, Object>> save(@RequestBody Map<String, Object> param, Model model) throws Exception {
...
//		Map<String, Object> param = getQueryMap();
		...
		estimateService.saveEstimate(param);
		param.put("result_msg", Constants.EVENT_SAVE_SUCCESS);
	 ...
	 * @note :견적서 삭제
	 */
	@GetMapping(path = "/estimate/delete")
	public ResponseEntity<Map<String, Object>> delete(@RequestBody Map<String, Object> param, Model model)
			throws Exception {
		/* return map */
		Map<String, Object> returnMap = new HashMap<String, Object>();

		estimateService.deleteEstimate(param);
...
//		}
//
//		model.addAttribute("data", estimateService.selectEstimate(param));
//
//		/* select file info */
