        ...
        <div class="card">
            <div class="card-body ">
                <div class="row">
					...
					<hr>
						<div class="col-md-4 col-12">
						<label class="form-label text-muted">워커맨팀</label>
						<h5 class="main_type">${data.main_type }</h5>
					</div>
					<div class="col-md-4 col-12">
					...
					<hr>
					<div class="col-md-4 col-12">
						<label class="form-label text-muted">전문분야</label>
						<h5 >${data.special_cd }</h5>
					</div>
					<div class="col-md-4 col-12">
						<label class="form-label text-muted">숙련도</label>
...
<script>
$(function(){
	console.log('어드민id','${data.admin_id}');
	...
	$("#move_edit").on("click", function(e){
		let param = {admin_id: "${data.admin_id}",w_admin: "02", admin_no: "${data.admin_no}"}
		console.log('파람',param);
		postPage("/operation/workerman/form", param);
	});	
});
