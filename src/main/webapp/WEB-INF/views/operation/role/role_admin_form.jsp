			...
			<form class="form-horizontal form-bordered" data-parsley-validate="true" name="frm" id="frm" novalidate="" enctype="multipart/form-data">
				<div class="row">			
					<div class="col-md-6 col-12 mt-3">
						...
						<%-- <input class="form-control " type="text" id="name" name="name" value="${data.name }" placeholder="권한명을 선택해주세요" data-parsley-required="true"  data-parsley-error-message="권한명을 정확히 입력하세요."> --%>
						<select class="form-select" id="role_no" name="role_no" data-parsley-required="true" placeholder="권한명을 선택해주세요" data-parsley-required="true"  data-parsley-error-message="권한명을 정확히 입력하세요.">
					...
					<div class="col-md-6 col-12 mt-3">
						...
						<%-- <input class="form-control " type="text" id="name" name="name" value="${data.name }" placeholder="권한명을 선택해주세요" data-parsley-required="true"  data-parsley-error-message="권한명을 정확히 입력하세요."> --%>
						<select class="form-select" id="admin_no" name="admin_no" data-parsley-required="true" placeholder="권한 관리자명을 선택해주세요" data-parsley-required="true"  data-parsley-error-message="권한 관리자명을 정확히 입력하세요.">
								<option value="">선택</option>
...
<script>
	...
	$(function(){
		...
		$("#_dev-save").on("click", function(e){
			...
			console.log("role_no",$("#role_no").val());
			/* validate */
