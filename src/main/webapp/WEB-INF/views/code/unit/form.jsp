...
<!-- ================== BEGIN PAGE HTML ================== -->
    ...
    <h1 class="page-header">단위 <span class="d-block small">코드관리</span></h1>
    <div class="card">
        <div class="card-header">
            <h3 class="mb-0">단위 등록</h3>
        </div>
        <div class="card-body">
   			<form class="form-horizontal form-bordered" data-parsley-validate="true" name="save_Form" id="save_Form" novalidate="" enctype="multipart/form-data">
			${data.code_no }
			<input type="hidden" id="code_no" name="code_no" value="${data.code_no }" >
            <div class="row">
                <div class="col-md-6 col-12 mt-3">
                    <label class="form-label">단위명 <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" 
                    	...
                    	data-parsley-error-message="단위명을 정확히 입력하세요."
                    	/>
                </div>
                <div class="col-md-6 col-12 mt-3 custom-type-p">
						<label class="form-label" for="branch_no">사용여부<span class="text-danger">*</span></label>
					    <select name="use_yn" class="form-control" placeholder="사용여부" data-parsley-required="true" data-parsley-id="8" aria-describedby="parsley-id-8" data-parsley-error-message="사용여부를 선택하세요">
                ...
                <div class="col-md-12 col-12 mt-3">
                    ...
                    <input type="text" class="form-control" 
                    	...
                    	id="remarks" 
                    	name="code_memo" 
                    	value="${data.code_memo }" 
                    	data-parsley-required="false"
                    	data-parsley-error-message="단위 설명을 입력하세요." 
                    	/>
                </div>
...
<script>
	...
	$(function(){
		...
		$("#_dev-save").on("click", function(e){
			...
			const _url = "/code/unit/save/ajax";	// ajax url
			const _form = "save_Form";	// form name
			
			/* validate */
			let validate = $("#save_Form").parsley().validate();
