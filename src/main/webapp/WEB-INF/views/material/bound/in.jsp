...
<!-- ================== BEGIN PAGE HTML ================== -->
    <ol class="breadcrumb float-xl-end">
        ...
        <li class="breadcrumb-item active">입고전표</li>
    </ol>

    <h1 class="page-header">입고 <span class="d-block small">자재관리</span></h1>
    <div class="card">
        <div class="card-header">
            <h3 class="mb-0">입고 등록</h3>
        </div>
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12 mt-3">
                    <label class="form-label">입고위치 <span class="text-danger">*</span></label>
					<tags:code-radio
                ...
                <div class="col-md-6 col-12 mt-3">
                    <label class="form-label">입고사유 <span class="text-danger">*</span></label>
					<tags:code-radio
						codeList="${income_type }"
						checked="${data.income_type }"
						name="income_type"
						required="true"
						initValue="01"
					/>
                ...
                <div class="col-md-6 col-12 mt-3" name="income_type_01_03">
                ...
                <div class="col-md-3 col-12 mt-3" name="income_type_01_02_99">
					...
					<select class="form-select" id="vendor_no" name="vendor_no" data-parsley-required="true" >
						...
						<option value="${item.vendor_no}" 
							...
							${item.vendor_no eq data.vendor_no?" selected":"" }
                ...
                <div class="col-md-12 col-12 mt-3" name="income_type_99_03" style="display:none">
...
/* 	    $("#work_no").on("change", function(){
	    ...
	    $("[name=income_type]").on("change", function(){
	    	let _income_type = $(this).val();
			$("[name^=income_type_]").each(function(idx, item){
				let _name = $(this).attr("name");
				if(_name.indexOf(_income_type) > -1) {
					$(this).show();
				}
				else {
					$(this).hide();
			...
			$("#saveForm input,select").attr('data-parsley-required', 'false');
			$('#bound_date').attr('data-parsley-required', 'true');
			...
			// 반납추가
			$('#label_etc_remarks').html('기타사유<span class="text-danger">*</span>');
			...
			else if(_income_type == '03'){ // 
				$('#work_no').attr('data-parsley-required', 'true');
				$('#work_name').attr('data-parsley-required', 'true');
				$('#label_etc_remarks').html('반납사유<span class="text-danger">*</span>');
				$('#etc_remarks').attr('placeholder', '반납사유');
				$('#etc_remarks').attr('data-parsley-required', 'true');
			}
			else if(_income_type == '01'){ // 
				$('#vendor_no').attr('data-parsley-required', 'true');
			}
			else if(_income_type == '99'){ // 
				$('#vendor_no').attr('data-parsley-required', 'true');
				$('#etc_remarks').attr('data-parsley-required', 'true');
			}
