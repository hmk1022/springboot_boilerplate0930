...
<!-- ================== BEGIN PAGE HTML ================== -->
    ...
    <div class="card">
        ...
        <div class="card-body">
			...
			<input type="hidden" id="bound_type" name="bound_type" value="01" >
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12 mt-3">
					...
					<tags:code-radio
						codeList="${bound_locate }"
						checked="${data.bound_locate }"
						name="bound_locate"
						required="true"
						initValue="01"
					/>
                ...
                <div class="col-md-3 col-12 mt-3" name="out_type_02" style="display:none">
					<label class="form-label">워커맨<span class="text-danger">*</span></label>
					<select class="form-select" id="out_admin_no" name="out_admin_no" data-parsley-required="true" >
						<option value=''>선택</option>
						<c:forEach items="${workerman_list }" var="item">
						<option value="${item.admin_no}" ${item.admin_no eq data.out_admin_no?'selected':'' }>${item.admin_name}</option>
						</c:forEach>
					</select>
				</div>
				
                <div class="col-md-12 col-12 mt-3" name="out_type_99" style="display:none">
				...
				<div class="modal-body">
					...
					<!-- <div class="form-row">
				  	...
				  	<div class="form-row" name="div_all_material" >
					    ...
					    <div class="col-md-3 mb-3">
					      ...
					      <input type="text" class="form-control" id="purchased_price" name="purchased_price" placeholder="단가" data-parsley-required="true" disabled>
					    </div>
				  	</div>
					...
					<div class="form-row mt-3">
					    ...
					    <div class="col-md-3 mb-3">
					      ...
					      <input type="number" class="form-control" id="total_material_price" name="total_material_price" value="0" placeholder="금액" readonly>
					    </div>
				  	</div>
...
<script>
	...
	$(function(){
		...
		$("#material_bound_item_list").on("click", "#del-material", function (e) {
			e.preventDefault();
			removeMaterialBoundItem($(this).data("material_inout_no"));
		});
			...
			Utils.requestMultiAjax(_name, _url, _form, {
	            success:  function(data) {
		          	...
		          	if(Utils.isEmpty($("[name=material_bound_no]").val())){
			          	$("[name=material_bound_no]").val(data);
		          	}
...
/* 	    $("#material_name").on("change", function(e){
            ...
            success:  function(data) {
	          	...
	          	if(Utils.isEmpty(data.data)){
	          		...
	          		$.each(data.data, function(idx, item){
	    				...
	    				'<td class="with-btn" nowrap=""><a href="#" class="btn btn-sm btn-white width-60" id="del-material" data-material_inout_no="'+item.material_inout_no+'">삭제</a></td>'+
	    				'</tr>';
	...
	function removeMaterialBoundItem(material_inout_no){
