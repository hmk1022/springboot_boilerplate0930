...
<!--         <div style="margin-top: 10px; margin-left: 10px;">
			<ul class="nav nav-pills">
			    <li class="nav-item active">
			        <a href="#MAT" data-toggle="tab" data-url="MAT" class="nav-link active" aria-expanded="true" name="material_add_type" search="">자재명</a>
			    </li>
			    <li class="nav-item">
			        <a href="#MAT" data-toggle="tab" data-url="MAT" class="nav-link" aria-expanded="false" name="material_add_type" add="">자재추가</a>
			    </li>
			</ul>
		</div> -->
            ...
            <div class="row">
				<div class="col-md-3 col-12 mt-3">
                    ...
                    <input type="text" class="form-control" 
                    	placeholder="자재" 
                    	value="${data.material_id }" readonly 
                    	/>
                </div>
				<div class="col-md-3 col-12 mt-3">
                ...
                <div class="col-md-3 col-12 mt-3">
                    ...
                    <select class="form-select" id="cate3" name="category_no" data-parsley-required="false" data-parsley-error-message="소분류를 선택하세요.">
						<option value="">선택</option>
...
<%-- <c:if test="${empty data.material_no }">
 ...
 <c:if test="${!empty data.material_no }">
    <button class="btn btn-gray" name="_button_page_view" data-to_url="/material/view" data-to_param="material_no^${data.material_no}">cancel</button>
		...
		<button class="btn btn-gray" id="_dev-close" >close</button>
