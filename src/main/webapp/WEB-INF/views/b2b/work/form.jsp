...
<%@ include file="/WEB-INF/commons/taglibs.jsp"%>
	...
	<!-- begin page-header -->
	<h1 class="page-header">작업마스터 <span class="d-block small">B2B 작업 관리</span></h1>
	<!-- end page-header -->
	<!-- begin panel -->
				...
				<div class="row">
					<div class="col-md-6 col-12 mt-3">
						...
						<div class="is-invalid">
							...
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" id="work_target_02" name="work_target" value="02" >
					...
					<div class="col-md-6 col-12 mt-3 custom-type-p">
						...
						<select class="form-select" id="customer_no" name="customer_no" data-parsley-required="true" data-parsley-id=""
					...
					<div class="col-md-6 col-12 mt-3 custom-type-p" >
						<label class="form-label" for="req_name">담당자명 * </label>
					...
					<div class="col-md-6 col-12 mt-3 custom-type-c">
						<label class="form-label" for="req_name">고객명 * </label>
						<input class="form-control " type="text" id="req_name" name="req_name" value="${data.req_name }" placeholder="한글,영문,숫자 입력 가능" data-parsley-required="true" data-parsley-id="2" aria-describedby="parsley-id-2">
					</div>
					<div class="col-md-6 col-12 mt-3">
						<label class="form-label" for="req_hp">연락처 * </label>
						<input class="form-control " type="text" id="req_hp" name="req_hp" value="${data.req_hp }" placeholder="숫자만 입력" data-parsley-required="true" data-parsley-id="2" aria-describedby="parsley-id-2" >
					</div>
					<div class="col-md-6 col-12 mt-3">
						<label class="form-label" for="title">현장주소1 * </label>
						<input type="text" id="work_addr1" name="work_addr1" class="form-control" placeholder="주소 검색" onclick="execDaumPostcode();" value="" readonly>
					</div>
					<div class="col-md-6 col-12 mt-3">
						<label class="form-label" for="title">현장주소2 * </label>
						<input type="text" id="work_addr2" name="work_addr2" class="form-control" placeholder="상세주소" value="">
					</div>

					<div class="col-md-12 col-12 mt-3 ">
						<label class="form-label" for="location_name">공사명 * </label>
						<input class="form-control " type="text" id="location_name" name="location_name" value="${data.location_name }" placeholder="한글,영문,숫자 (100자 이내)" data-parsley-required="true" data-parsley-id="2" aria-describedby="parsley-id-2" >
					</div>

					<div class="col-md-12 col-12 mt-3 ">
						<label class="form-label" for="req_content">요청사항 </label>
						<textarea class="form-control" name="req_content" id="req_content" placeholder="고객 요청사항 입력(500자 이내)">${data.req_content }</textarea>
					</div>
					...
					<div class="col-md-12 col-12 mt-3 ">
						<label class="form-label" for="manager_admin_no">공무 * </label>
							<select class="form-select" id="manager_admin_no" name="manager_admin_no" data-parsley-required="true" data-parsley-id="">
	...
	$(function(){
		...
		$("input[name=\"custom_type\"",$this).on("click",function(){
			if(this.value == "p"){
				$(".custom-type-p").show();
				$(".custom-type-c").hide();
				$(".custom-type-p .form-control").attr("data-parsley-required",true)
				$(".custom-type-c .form-control").attr("data-parsley-required",false)
			}else if(this.value == "c"){
				$(".custom-type-p").hide();
				$(".custom-type-c").show();
				$(".custom-type-p .form-control").attr("data-parsley-required",false)
				$(".custom-type-c .form-control").attr("data-parsley-required",true)
			}
		})
		...
		$("#_dev-save").on("click", function(e){
			...
			const _url = "/b2b/work/save/ajax";	// ajax url
